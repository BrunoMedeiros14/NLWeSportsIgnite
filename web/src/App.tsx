    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-1.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-2.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-3.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-4.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-5.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-6.png" alt="__blank" />
          <div className="w-full pt-16 pb-4 px-4 bg-nlwBoxGradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block">
              World of Warcraft
            </strong>
