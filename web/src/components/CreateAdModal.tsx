...
export function CreateAdModal() {
  ...
  useEffect(() => {
    axios('https://nlw-server.brunodemedeiros14.repl.co/games').then(
      response => {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try {
      await axios.post(
        `https://nlw-server.brunodemedeiros14.repl.co/games/${data.game}/ads`,
        {
          name: data.name,
